...
public class CatalanoWrapper {
	...
	public static Instance applyFilter(Instance inst, Object filter) {
	...
	public static FastBitmap instance2FastBitmap(Instance inst) {
	...
	public static Instance fastBitmap2GrayScaledInstance(FastBitmap fb) {
